...
trendOMeterApp.config(function($routeProvider, $translateProvider) {
    ...
    $translateProvider.translations('en', {
      ...
      //panel page
      CONGRATULATIONS1: 'These are',
      CONGRATULATIONS2: 'the hottest trends:',
      RESULTS: 'Get the results',
      VOTE_AGAIN: 'VOTE AGAIN',
      //user page
      CALL_TO_ACTION1: 'Get the full results and',
      CALL_TO_ACTION2: 'a detailed analysis of each trend',
      NAME: 'Name*',
      EMAIL: 'E-mail*',
      COMPANY: 'Company',
      ROLE: 'Role',
      ...
      THANKS: 'Soon we\'ll be sending you the Retail Trend Hot List\'s results and detailed analysis.',
